...
4. **Describe document content:** each entry accurately and concisely summarizes what the document contains; one shared instruction in root `AGENTS.md` document navigation tells Agents to read relevant entries.
